...
import { ProductGuardService } from '../../assets/Services/product-guard.service';
...
const routes: Routes = [
  ...
  { path: "edit/:id" , component: AddProductComponent , canActivate: [AuthguardService, ProductGuardService] } 
];
